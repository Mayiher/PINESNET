...
<div class="container">
    <h2>Bienvenido Vendedor <?php echo htmlspecialchars($_SESSION['admin']['nombre']) . ' ' . htmlspecialchars($_SESSION['admin']['apellido']); ?></h2>
</div>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-8">
                    <div id="login-box" class="col-md-12">
                        ...
                        <input type="hidden" name="id_usuario" value="<?php echo isset($_POST['cliente_identificacion']) ? $_POST['cliente_identificacion'] : ''; ?>" />
