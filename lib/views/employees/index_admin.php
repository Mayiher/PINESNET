...
if (!isset($_SESSION['users']) || strtolower($_SESSION['users']['rol'])!=='administrator') {
  echo '<script>alert("Debe iniciar sesión como administrador.");location.href="/lib/views/auth/login-register/login-register.php";</script>';
  exit;
}
...
if (!in_array($active,$sections)) $active='Administradores';
...
$labels = [
  ...
  'subtotal'=>'Subtotal','total_iva'=>'Total IVA','descuento'=>'Descuento','total'=>'Total'
];
?>
